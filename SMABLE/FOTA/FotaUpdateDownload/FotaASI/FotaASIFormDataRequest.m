...
#import "FotaASIFormDataRequest.h"


// Private stuff
@interface FotaASIFormDataRequest ()
...
@implementation FotaASIFormDataRequest
...
- (void)addFile:(NSString *)filePath withFileName:(NSString *)fileName andContentType:(NSString *)contentType forKey:(NSString *)key
{
	...
	if (!fileExists || isDirectory) {
		[self failWithError:[NSError errorWithDomain:FotaNetworkRequestErrorDomain code:ASIInternalErrorWhileBuildingRequestType userInfo:[NSDictionary dictionaryWithObjectsAndKeys:[NSString stringWithFormat:@"No file exists at %@",filePath],NSLocalizedDescriptionKey,nil]]];
	}
	...
	if (!contentType) {
		contentType = [FotaASIHTTPRequest mimeTypeForFileAtPath:filePath];
	}
...
{
	FotaASIFormDataRequest *newRequest = [super copyWithZone:zone];
