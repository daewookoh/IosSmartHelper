...
#import "FotaASICloudFilesObjectRequest.h"
#import "FotaASICloudFilesObject.h"


@implementation FotaASICloudFilesObjectRequest
...
+ (id)storageRequestWithMethod:(NSString *)method containerName:(NSString *)containerName {
	NSString *urlString = [NSString stringWithFormat:@"%@/%@", [FotaASICloudFilesRequest storageURL], containerName];
	FotaASICloudFilesObjectRequest *request = [[[FotaASICloudFilesObjectRequest alloc] initWithURL:[NSURL URLWithString:urlString]] autorelease];
...
+ (id)storageRequestWithMethod:(NSString *)method containerName:(NSString *)containerName queryString:(NSString *)queryString {
	NSString *urlString = [NSString stringWithFormat:@"%@/%@%@", [FotaASICloudFilesRequest storageURL], containerName, queryString];
	FotaASICloudFilesObjectRequest *request = [[[FotaASICloudFilesObjectRequest alloc] initWithURL:[NSURL URLWithString:urlString]] autorelease];
	[request setRequestMethod:method];
	[request addRequestHeader:@"X-Auth-Token" value:[FotaASICloudFilesRequest authToken]];
	request.containerName = containerName;
...
+ (id)storageRequestWithMethod:(NSString *)method containerName:(NSString *)containerName objectPath:(NSString *)objectPath {
	NSString *urlString = [NSString stringWithFormat:@"%@/%@/%@", [FotaASICloudFilesRequest storageURL], containerName, objectPath];
	FotaASICloudFilesObjectRequest *request = [[[FotaASICloudFilesObjectRequest alloc] initWithURL:[NSURL URLWithString:urlString]] autorelease];
	[request setRequestMethod:method];
	[request addRequestHeader:@"X-Auth-Token" value:[FotaASICloudFilesRequest authToken]];
	request.containerName = containerName;
...
+ (id)containerInfoRequest:(NSString *)containerName {
	FotaASICloudFilesObjectRequest *request = [FotaASICloudFilesObjectRequest storageRequestWithMethod:@"HEAD" containerName:containerName];
	return request;
}
...
+ (id)objectInfoRequest:(NSString *)containerName objectPath:(NSString *)objectPath {
	FotaASICloudFilesObjectRequest *request = [FotaASICloudFilesObjectRequest storageRequestWithMethod:@"HEAD" containerName:containerName objectPath:objectPath];
	return request;
}
...
+ (id)listRequestWithContainer:(NSString *)containerName limit:(NSUInteger)limit marker:(NSString *)marker prefix:(NSString *)prefix path:(NSString *)path {
	NSString *queryString = [FotaASICloudFilesObjectRequest queryStringWithContainer:containerName limit:limit marker:marker prefix:prefix path:path];
	FotaASICloudFilesObjectRequest *request = [FotaASICloudFilesObjectRequest storageRequestWithMethod:@"GET" containerName:containerName queryString:queryString];
	return request;
}

+ (id)listRequestWithContainer:(NSString *)containerName {
	return [FotaASICloudFilesObjectRequest listRequestWithContainer:containerName limit:0 marker:nil prefix:nil path:nil];
}
...
+ (id)getObjectRequestWithContainer:(NSString *)containerName objectPath:(NSString *)objectPath {
	return [FotaASICloudFilesObjectRequest storageRequestWithMethod:@"GET" containerName:containerName objectPath:objectPath];
}

- (FotaASICloudFilesObject *)object {
	FotaASICloudFilesObject *object = [FotaASICloudFilesObject object];
...
+ (id)putObjectRequestWithContainer:(NSString *)containerName object:(FotaASICloudFilesObject *)object {
...
+ (id)putObjectRequestWithContainer:(NSString *)containerName objectPath:(NSString *)objectPath contentType:(NSString *)contentType objectData:(NSData *)objectData metadata:(NSDictionary *)metadata etag:(NSString *)etag {
	...
	FotaASICloudFilesObjectRequest *request = [FotaASICloudFilesObjectRequest storageRequestWithMethod:@"PUT" containerName:containerName objectPath:objectPath];
...
+ (id)postObjectRequestWithContainer:(NSString *)containerName object:(FotaASICloudFilesObject *)object {
...
+ (id)postObjectRequestWithContainer:(NSString *)containerName objectPath:(NSString *)objectPath metadata:(NSDictionary *)metadata {
	FotaASICloudFilesObjectRequest *request = [FotaASICloudFilesObjectRequest storageRequestWithMethod:@"POST" containerName:containerName objectPath:objectPath];
...
+ (id)deleteObjectRequestWithContainer:(NSString *)containerName objectPath:(NSString *)objectPath {
	FotaASICloudFilesObjectRequest *request = [FotaASICloudFilesObjectRequest storageRequestWithMethod:@"DELETE" containerName:containerName objectPath:objectPath];
	return request;
}
...
- (void)parser:(NSXMLParser *)parser didStartElement:(NSString *)elementName namespaceURI:(NSString *)namespaceURI qualifiedName:(NSString *)qName attributes:(NSDictionary *)attributeDict {
	...
	if ([elementName isEqualToString:@"object"]) {
		[self setCurrentObject:[FotaASICloudFilesObject object]];
	}
