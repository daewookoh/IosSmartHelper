...
@class FotaASICloudFilesObject;

@interface FotaASICloudFilesObjectRequest : FotaASICloudFilesRequest <NSXMLParserDelegate> {
	...
	FotaASICloudFilesObject *currentObject;
...
@property (retain) FotaASICloudFilesObject *currentObject;
