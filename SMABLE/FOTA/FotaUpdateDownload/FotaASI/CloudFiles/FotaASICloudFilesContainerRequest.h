...
@class FotaASICloudFilesContainer, FotaASICloudFilesContainerXMLParserDelegate;

@interface FotaASICloudFilesContainerRequest : FotaASICloudFilesRequest {
	
	// Internally used while parsing the response
	NSString *currentContent;
	NSString *currentElement;
	FotaASICloudFilesContainer *currentObject;
	FotaASICloudFilesContainerXMLParserDelegate *xmlParserDelegate;
}
...
@property (retain) FotaASICloudFilesContainerXMLParserDelegate *xmlParserDelegate;
