...
@implementation FotaASICloudFilesRequest

+ (void)initialize
{
	if (self == [FotaASICloudFilesRequest class]) {
...
+ (id)authenticationRequest
{
	...
	FotaASIHTTPRequest *request = [[[FotaASIHTTPRequest alloc] initWithURL:[NSURL URLWithString:rackspaceCloudAuthURL]] autorelease];
...
{
	[accessDetailsLock lock];
	FotaASIHTTPRequest *request = [FotaASICloudFilesRequest authenticationRequest];
