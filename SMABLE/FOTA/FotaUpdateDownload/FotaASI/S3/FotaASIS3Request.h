...
extern NSString *const FotaASIS3AccessPolicyPrivate; // This is the default in S3 when no access policy header is provided
extern NSString *const FotaASIS3AccessPolicyPublicRead;
extern NSString *const FotaASIS3AccessPolicyPublicReadWrite;
extern NSString *const FotaASIS3AccessPolicyAuthenticatedRead;
extern NSString *const FotaASIS3AccessPolicyBucketOwnerRead;
extern NSString *const FotaASIS3AccessPolicyBucketOwnerFullControl;

// Constants for requestScheme - defaults is ASIS3RequestSchemeHTTP
extern NSString *const FotaASIS3RequestSchemeHTTP;
extern NSString *const FotaASIS3RequestSchemeHTTPS;
...
@interface FotaASIS3Request : FotaASIHTTPRequest <NSCopying, NSXMLParserDelegate> {
