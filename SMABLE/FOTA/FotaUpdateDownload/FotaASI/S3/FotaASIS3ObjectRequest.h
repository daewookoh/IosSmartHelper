...
extern NSString *const FotaASIS3StorageClassStandard;
extern NSString *const FotaASIS3StorageClassReducedRedundancy;

@interface FotaASIS3ObjectRequest : FotaASIS3Request {
