...
@class FotaASIDataDecompressor;

extern NSString *FotaASIHTTPRequestVersion;
...
extern NSString* const FotaNetworkRequestErrorDomain;
...
extern unsigned long const FotaASIWWANBandwidthThrottleAmount;
...
@interface FotaASIHTTPRequest : NSOperation <NSCopying> {
	...
	id <FotaASIHTTPRequestDelegate> delegate;
	...
	id <FotaASIHTTPRequestDelegate, FotaASIProgressDelegate> queue;
	...
	id <FotaASIProgressDelegate> uploadProgressDelegate;
	...
	id <FotaASIProgressDelegate> downloadProgressDelegate;
	...
	FotaASIHTTPRequest *mainRequest;
	...
	id <FotaASICacheDelegate> downloadCache;
	...
	FotaASIDataDecompressor *dataDecompressor;
	...
	FotaASIHTTPRequest *PACFileRequest;
...
@property (assign) FotaASIHTTPRequest *mainRequest;
...
@property (assign) id <FotaASICacheDelegate> downloadCache;
...
#endif
@property (retain) FotaASIDataDecompressor *dataDecompressor;
