...
- (void)battery:(NSString*)battery;
- (void)findPhone:(NSString*)flag;
- (void)setGoal:(NSString*)goal;
- (void)getDeviceNameAndAddress:(NSString*)mac;
- (void)connectCancel;
- (void)connectSuccess;
- (void)takePhoto;
- (void)closePhoto;
- (void)setSit:(SmaSeatInfo*)sit;
- (void)setAlarm:(NSMutableArray *)array;
- (void)insertSport:(NSMutableArray *)array;
- (void)insertHeart:(NSMutableArray *)array;
- (void)insertSleep:(NSMutableArray *)array;
- (void)insertExercise:(NSMutableArray *)array;
- (void)insertTracker:(NSMutableArray *)array;
@end

@interface SmaBLE : NSObject
@property (nonatomic, assign) NSString* battery;
...
@property (nonatomic, weak) id<SmaCoreBlueToolDelegate> delegate_swift;
...
/**
 ...
 @param weathe 天气设置对像（各参数请参考该对象参数）
 */
